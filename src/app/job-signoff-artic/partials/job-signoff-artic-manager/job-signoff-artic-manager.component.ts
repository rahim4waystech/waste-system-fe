...
@Component({
  selector: 'app-job-signoff-artic-manager',
  templateUrl: './job-signoff-artic-manager.component.html',
  styleUrls: ['./job-signoff-artic-manager.component.scss']
})
export class JobSignoffArticManagerComponent implements OnInit {
  ...
  buttons: GridButton[] = [
    {label: 'Edit job', link: '/job-signoff/artic/edit/:id', type: 'btn-warning', trigger: this.isSighOffButtonVisible} as GridButton,
  ...
  columns: GridColumn[] = [
    ...
    {active: true, label: 'Total Price', field: 'qty', value: (v,r) => this.getTotalPrice(r)} as GridColumn,
