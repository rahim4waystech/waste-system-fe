...
@Component({
  selector: 'app-order-quick-accounts',
  templateUrl: './order-quick-accounts.component.html',
  styleUrls: ['./order-quick-accounts.component.scss']
})
export class OrderQuickAccountsComponent implements OnInit {
