  ...
  ngOnInit(): void {
    ...
    if(environment.invoicing.companyName === 'Total Recycling Scotland') {
      this.columns = [
        ...
        {active: true, label: 'Date', field: 'date', value: v => moment(v).format('DD/MM/YYYY')} as GridColumn,
        {active: true, label: 'Time', field: 'time'} as GridColumn,
        {active: true, label: 'Grade', field: 'grade.name'} as GridColumn,
        {active: true, label: 'Container Type', field: 'containerType.name', value: (v, r) => r.containerType ? r.containerType.name : 'N/A'} as GridColumn,
        {active: true, label: 'Container Size', field: 'containerSizeType.name', value: (v, r) => r.containerSizeType ? r.containerSizeType.size + ' Yard' : 'N/A'} as GridColumn,
      ...
      this.relationships.push('containerType', 'containerSizeType');
    }
