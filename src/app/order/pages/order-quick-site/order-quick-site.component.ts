...
@Component({
  selector: 'app-order-quick-site',
  templateUrl: './order-quick-site.component.html',
  styleUrls: ['./order-quick-site.component.scss']
})
export class OrderQuickSiteComponent implements OnInit {
  ...
  openAddSite() {
    this.modalService.open('addNewSiteOrderModal');
  }
}
