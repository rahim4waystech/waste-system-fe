...
@Component({
  selector: 'app-driver-hours-advanced',
  templateUrl: './driver-hours-advanced.component.html',
  styleUrls: ['./driver-hours-advanced.component.scss']
})
export class DriverHoursAdvancedComponent implements OnInit {

  buttons: GridButton[] = [
    {label: 'Edit', link: '/drivers/hours/edit/:id', type: 'btn-warning',} as GridButton,
  ]
  columns: GridColumn[] = [
