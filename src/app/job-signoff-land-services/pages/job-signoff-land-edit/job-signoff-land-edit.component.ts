...
@Component({
  selector: 'app-job-signoff-land-edit',
  templateUrl: './job-signoff-land-edit.component.html',
  styleUrls: ['./job-signoff-land-edit.component.scss']
})
export class JobSignoffLandEditComponent implements OnInit {
...
createNewOrderLines(): void {
  ...
  .subscribe(() => {
    ...
    const orderlinesSave = this.orderLines.filter(o => o.qty > -1);
