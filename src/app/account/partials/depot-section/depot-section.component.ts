...
@Component({
  selector: 'app-depot-section',
  templateUrl: './depot-section.component.html',
  styleUrls: ['./depot-section.component.scss']
})
export class DepotSectionComponent implements OnInit {
