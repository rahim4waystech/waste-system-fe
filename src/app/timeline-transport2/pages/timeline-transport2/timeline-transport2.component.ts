...
@Component({
  selector: 'app-timeline-transport2',
  templateUrl: './timeline-transport2.component.html',
  styleUrls: ['./timeline-transport2.component.scss']
})
export class TimelineTransport2Component implements OnInit {
