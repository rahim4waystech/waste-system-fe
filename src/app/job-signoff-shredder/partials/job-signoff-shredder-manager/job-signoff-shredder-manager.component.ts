...
@Component({
  selector: 'app-job-signoff-shredder-manager',
  templateUrl: './job-signoff-shredder-manager.component.html',
  styleUrls: ['./job-signoff-shredder-manager.component.scss']
})
export class JobSignoffShredderManagerComponent implements OnInit {
  ...
  buttons: GridButton[] = [
    {label: 'Edit job', link: '/job-signoff/shredder/edit/:id', type: 'btn-warning', trigger: this.isSighOffButtonVisible} as GridButton,
