...
@Component({
  selector: 'app-timeline-transport-main-vertical',
  templateUrl: './timeline-transport-main-vertical.component.html',
  styleUrls: ['./timeline-transport-main-vertical.component.scss']
})
export class TimelineTransportMainVerticalComponent implements OnInit {
