...
@Component({
  selector: 'app-timeline-transport-accepted-orders',
  templateUrl: './timeline-transport-accepted-orders.component.html',
  styleUrls: ['./timeline-transport-accepted-orders.component.scss']
})
export class TimelineTransportAcceptedOrdersComponent implements OnInit, OnDestroy {
  ...
  page: number = 1;
  sortBy: string = 'time';
  orderTypeId: number = environment.defaults.defaultTimeline; // tipper
  search: string = '';
  draggingId: number = -1;
