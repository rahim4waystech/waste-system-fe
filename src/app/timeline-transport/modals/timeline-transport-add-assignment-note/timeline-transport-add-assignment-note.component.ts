...
@Component({
  selector: 'app-timeline-transport-add-assignment-note',
  templateUrl: './timeline-transport-add-assignment-note.component.html',
  styleUrls: ['./timeline-transport-add-assignment-note.component.scss']
})
export class TimelineTransportAddAssignmentNoteComponent implements OnInit {
  ...
  save() {
    ...
    .subscribe(() => {
      ...
      this.modalService.close('transportNoteAssignmentCreationModal');
    })
  }
}
