...
@Component({
  selector: 'app-timeline-transport-all-orders',
  templateUrl: './timeline-transport-all-orders.component.html',
  styleUrls: ['./timeline-transport-all-orders.component.scss']
})
export class TimelineTransportAllOrdersComponent implements OnInit {
  ...
  cancel() {
    this.modalService.close('transportAllOrdersModal');
  }
