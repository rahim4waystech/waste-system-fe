...
@Component({
  selector: 'app-timeline-transport-order-information',
  templateUrl: './timeline-transport-order-information.component.html',
  styleUrls: ['./timeline-transport-order-information.component.scss']
})
export class TimelineTransportOrderInformationComponent implements OnInit,OnChanges {
  ...
  close() {
    this.modalService.close('orderTransportInformationModal');
  }
