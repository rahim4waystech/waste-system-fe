...
@Component({
  selector: 'app-timeline-transport-add-note',
  templateUrl: './timeline-transport-add-note.component.html',
  styleUrls: ['./timeline-transport-add-note.component.scss']
})
export class TimelineTransportAddNoteComponent implements OnInit, OnChanges {
  ...
  save() {
    ...
    .subscribe(() => {
      ...
      this.modalService.close('transportNoteCreationModal');
    })
  }
