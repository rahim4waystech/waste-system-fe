...
@Component({
  selector: 'app-timeline-transport-copy-job-to-unit',
  templateUrl: './timeline-transport-copy-job-to-unit.component.html',
  styleUrls: ['./timeline-transport-copy-job-to-unit.component.scss']
})
export class TimelineTransportCopyJobToUnitComponent implements OnInit {
  ...
  cancel() {
    this.selectedUnit = -1;
    this.modalService.close('transportCopyJobToUnitModal');
  }
