...
export const environment = {
  production: true,
  publicUrl: 'http://blacks.fourways-technology.co.uk:3000/',
  strapLine: 'Yuill & Dodds TESTING (TESTING Version 1.59.0)',
  isSimply:false,
  logo: 'logo.jpg',
  api: {
    endpoint: 'http://blacks.fourways-technology.co.uk:3000/',
